...
SRC_FILES += \
  ...
  $(PROJ_DIR)/appli/objects/object_fall_sensor.c \
  $(PROJ_DIR)/appli/objects/object_matrix_leds.c \
  $(PROJ_DIR)/appli/objects/object_tracker_gps.c \
  $(PROJ_DIR)/appli/objects/object_touch_screen.c \
  $(PROJ_DIR)/appli/objects/object_ventilator.c \
  $(PROJ_DIR)/appli/objects/object_station_meteo_int.c \
  $(PROJ_DIR)/appli/objects/object_brightness_sensor.c \
  $(PROJ_DIR)/appli/objects/object_rfid.c \
  $(PROJ_DIR)/appli/objects/object_night_light.c \
  $(PROJ_DIR)/appli/objects/object_out_weather_station.c \
  $(PROJ_DIR)/appli/objects/object_voice_control.c \
  $(PROJ_DIR)/appli/objects/object_e_paper.c \
  $(PROJ_DIR)/appli/objects/object_wine_degustation.c \
  $(PROJ_DIR)/appli/objects/object_LCD_slider.c \
  ...
  $(PROJ_DIR)/bsp/lcd2x16/lcd2x16.c \
